...
# API for connect ERP --->
	...
	path('login/', login_view),
 	path('signup/', signup_view),
  	path('signup-vendor/', signup_vendor_view),
    path('login-otp/', loginwith_view),
    path('signup-send-otp/', signup_send_otp_view),
    path('signup-re-send-otp/', signup_re_send_otp_view),
    path('login-send-otp/', login_send_otp_view),
    path('login-re-send-otp/', login_re_send_otp_view),
    path('reset-password/', resetpassword_view),
