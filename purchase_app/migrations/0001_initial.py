# Generated by Django 5.0.1 on 2024-07-19 21:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('totaladmincommission', models.FloatField(blank=True, default=0.0, null=True)),
        ...
        migrations.CreateModel(
            name='PurchasesOrderItems',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField()),
                ('price', models.FloatField(blank=True, default=0.0, null=True)),
                ('tax', models.FloatField(blank=True, default=0.0, null=True)),
                ('admincommission', models.FloatField(blank=True, default=0.0, null=True)),
                ('total', models.FloatField(blank=True, default=0.0, null=True)),
                ...
                ('purchasesorder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purchasesorders', to='purchase_app.purchasesorder')),
